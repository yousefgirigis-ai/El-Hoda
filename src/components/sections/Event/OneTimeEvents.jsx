...
import { oneTimeEvents } from "../../../data/constants";
...
const OneTimeEvents = () => {
  ...
  const splitIndex = Math.ceil(oneTimeEvents.length / 2);
  const leftEvents = oneTimeEvents.slice(0, splitIndex);
  const rightEvents = oneTimeEvents.slice(splitIndex);
        ...
        <div className="mb-6 md:mb-8">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-black mb-4 md:mb-6 leading-tight">
            ...
            <span className="text-lg md:text-xl font-normal block mt-2">
              Special events and unique milestones.
            </span>
          </h2>
        </div>
