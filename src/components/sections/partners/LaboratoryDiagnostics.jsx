...
const LaboratoryDiagnostics = () => {
  ...
  // Filter laboratory diagnostics partners
  const laboratoryPartners = partners.filter((partner) =>
    ["Greiner Bio-One", "i-SENS", "Assure Tech", "ACON"].includes(partner.name),
  );

  // Map EXACT requested content
  const mappedPartners = laboratoryPartners.map((partner) => {
    let title = "";
    let description = "";
    let icon = null;
    ...
    switch (partner.name) {
      case "Greiner Bio-One":
        title = "Global Leader in Pre-Analytical Systems & Biotechnology";
        description =
          "Setting the international benchmark for specimen collection and laboratory excellence through ISO-certified safety and precision engineering.";
        icon = <Shield className="w-6 h-6" />;
        gradient = "from-red-600 to-red-700";
        break;

      case "i-SENS":
        title = "Pioneer in Advanced Biosensor & Point-of-Care Technology";
        description =
          "Delivering world-renowned diagnostic accuracy via advanced electrochemistry and specialized whole-blood monitoring systems.";
        icon = <Cpu className="w-6 h-6" />;
        gradient = "from-red-600 to-red-700";
        break;

      case "Assure Tech":
        title = "Specialist in Rapid Diagnostic Innovation & IVD Manufacturing";
        description =
          "Integrating large-scale R&D with global manufacturing standards to provide comprehensive IVD reagents and rapid testing platforms.";
        icon = <Zap className="w-6 h-6" />;
        gradient = "from-red-600 to-red-700";
        break;

      case "ACON":
        title = "Leader in Innovative IVD Solutions";
        description =
          "Advancing global healthcare through the development of smart, high-accuracy In-Vitro Diagnostic (IVD) platforms designed for maximum user-friendliness.";
    ...
    return {
      ...
      icon,
      gradient,
      bgColor: partner.color?.split(" ")[2] || "bg-red-100",
    };
  });
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <span className="text-sm font-semibold text-white">
                  Trusted Diagnostic Excellence Partners
                </span>
              ...
              <div className="flex flex-col lg:flex-row items-start justify-between gap-8">
                <div className="flex-1">
                  ...
                  >
                    Our Trusted Laboratory & Diagnostics Partners
                  </motion.h2>
                  <motion.p
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    Partnering with global leaders in diagnostic innovation,
                    laboratory safety, and precision medical technology to
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              Advancing healthcare through cutting-edge diagnostic solutions,
              precision laboratory systems, and innovative medical technologies
            </motion.p>
          </div>
        </motion.div>
