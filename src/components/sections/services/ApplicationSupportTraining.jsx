...
const ApplicationSupportTraining = () => {
  ...
  const trainingPrograms = [
    {
      ...
      description:
        "We empower our clients' personnel with the knowledge necessary to utilize all products effectively and safely, directly enhancing overall diagnostic accuracy and efficiency. Specialized training sessions cover the operation, daily maintenance, and quality control procedures for all diagnostic systems.",
      duration: "2–5 Days",
    ...
    },
    {
      ...
      description:
        "Focused training ensures the optimal use of diagnostic reagents, rapid tests, and consumables to achieve accurate clinical results. Expert consultation is also provided to help laboratories optimize diagnostic workflows from sample collection to final reporting.",
      duration: "3–7 Days",
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/factory12.jpg')",
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center">
            ...
            >
              <span className="text-white">Application Support & </span>
              <motion.span
                animate={{
            ...
            >
              We empower our clients' personnel with the knowledge necessary to
              utilize all products effectively and safely, directly enhancing
              overall diagnostic accuracy and efficiency.
            </motion.p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-24">
          {trainingPrograms.map((program, index) => (
            <motion.div
              ...
              animate={{ y: 0, opacity: 1 }}
              transition={{ delay: program.delay, duration: 0.6 }}
              whileHover={{
                y: -10,
            ...
            >
              ...
              <div className="relative bg-white rounded-3xl p-8 border border-gray-100">
                ...
                <motion.div
                  className={`w-20 h-20 rounded-2xl ${program.bgColor} flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300`}
                  whileHover={{ rotate: 5 }}
                >
                  <div className={`relative w-12 h-12 ${program.iconColor}`}>
                    <program.icon className="w-full h-full" />
                    <motion.div
                      className={`absolute inset-0 rounded-full ${program.bgColor} opacity-50`}
...
export default ApplicationSupportTraining;